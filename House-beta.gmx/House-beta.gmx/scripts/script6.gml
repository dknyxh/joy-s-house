...
while (i<global.roomy)
{
    ...
    {
        n = instance_create(200+j*(160-66+1)-i*66,400+i*66,obj_block)
        n.viewdepth = -1-i*2
        j+=1
    }
    i+=1
}
instance_create(200-13-global.roomy*66,400-33+global.roomy*66,obj_black)
instance_create(200-13-global.roomy*66+(160-66)*global.roomx,400-33+global.roomy*66,obj_black1)
instance_create(200-13+(160-66)*global.roomx,400-33,obj_black2)
instance_create(200-13-global.roomy*66-sprite_get_width(spr_black2),400-33+global.roomy*66,obj_black3)
//instance_create(1000,200,obj_wall)
instance_create(200-13,400-33,obj_wall1)
instance_create(200-13,400-33,obj_wall2)

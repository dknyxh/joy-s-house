...
while (i<global.roomy)
{
    ...
    {
        n = instance_create(200+j*(160-66+1)-i*66,300+i*66,obj_block)
        n.viewdepth = -1-i*2
        if (i==0 && j==2)
        {
             m= instance_create(n.x,n.y,obj_desk)
             m.depth = n.viewdepth
             n.have_item = m
        }
        if (i==0 && j==3)
        {
            m = instance_create(n.x,n.y,obj_closet)
             m.depth = n.viewdepth
             n.have_item = m
        }
        j+=1
...
instance_create(200-13-global.roomy*66,300-33+global.roomy*66,obj_black)
instance_create(200-13-global.roomy*66+(160-66)*global.roomx,300-33+global.roomy*66,obj_black1)
instance_create(200-13+(160-66)*global.roomx,300-33,obj_black2)
instance_create(200-13-global.roomy*66-sprite_get_width(spr_black2),300-33+global.roomy*66,obj_black3)
//instance_create(1000,200,obj_wall)
instance_create(200-13,300-33,obj_wall1)
instance_create(200-13,300-33,obj_wall2)
